---
title: "After 75 Miles of Running"
date: 2025-12-26T09:55:41-05:00
draft: false
tags: []
math: true
...
At the beginning, I didn't end up buying anything new. In Austin, I wore some sneakers from [Keen footwear](https://www.keenfootwear.com) which I accidentally soaked a few times in sudden downpours. I also wear a Fitbit watch that has heart rate monitoring built in. 

When I returned to New York, I ended up buying a [Brooks running shoe](https://www.brooksrunning.com/en_us). Shoes designed for running are usually lighter and have shock absorption. This makes for a more pleasant workout. 

> Did you use a training plan?

Initially, I used the [couch to 5k running plan](https://www.nhs.uk/better-health/get-active/get-running-with-couch-to-5k/couch-to-5k-running-plan/) developed by the UK's National Health Service (NHS). After completing that plan, I charted out my own path, with most of my sessions consisting of 30 minutes of running surrounded by 5 minutes of walking.

When I returned to New York, I saw that my city was hosting a [turkey trot](https://troyturkeytrot.com/) on Thanksgiving. That was a perfect amount of time to follow the program and see how things turn out!
...
I'm far from an expert in this area, but it's generally recommended to keep your [heart rate low](https://en.wikipedia.org/wiki/Long_slow_distance) when you're running. This helps improve your cardiovascular fitness over the long run. An informal test is to see if you can carry a conversation while running.

Formally, it's recommended to stay in "Zone 2" while running which is about 60-70% of your max heart rate.  We can use the Bruce protocol to find out our max heart rate, or for a much simpler approximation, we can use the Tanaka, Monahan, & Seals (2001) formula.
$$
hr_{max} = 208 - (0.7 * age)
$$
That means for a 30 year old their zone 2 heart rate lies between 112 and 130.
...
![High-up view of my starting position](/files/images/blog/ttslpaceflags.jpg)
...
I hit the finish line at [34 minutes and 14 seconds](https://www.zippy-reg.com/results/live/athlete/index.php?eid=228&bib=1508)! It's pretty exciting to hit a new personal best during a race.

Focusing on the race, I didn't end up taking too many photos. Instead here's a blurry snapshot from the [finish cam](https://www.youtube.com/watch?v=fLRtp4DtcB8) and a selfie of me with my participation medal.

![Screenshot of me passing the finish line with many others](/files/images/blog/ttfc2025.png)

![Selfie of me with the participation medal](/files/images/blog/ttselfie2025.jpg)
...
![Histogram of net times for all the participants](/files/images/blog/tthistnettime2025.png)
